...
description: Client Feedback Analyzer workflow automation skill. Use when a user needs Client Feedback Analyzer tasks planned, generated, analyzed, or reported with repeatable outputs, templates, and lightweight local scripts.
---
...
```bash
bash scripts/run.sh --task "example task" --outdir ../../tmp/client-feedback-analyzer
```
